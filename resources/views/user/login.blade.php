...
<form action="{{ url('/login')}}" method="post" class="relog">
    @csrf
    <div class="relog-form">
        <h2 class="relog-form__heading">Đăng Nhập</h2>
        <p class="relog-form__title">Nếu bạn chưa có tài khoản, <a href="/register" class="relog-form__link">đăng ký</a> tại đây</p>
        <div class="relog-form__info">
            <div class="relog-form__gr">
                <input type="text" class="relog-form__gr-input" placeholder="Tên đăng nhập" name="username" required>
            </div>
            <div class="relog-form__gr">
